        ...
        <div className="app-container">
            <Header />
                <Routes>
                    ...
                    />
                    <Route path="/events" element={<AllEventsPage outEvents={events} />} />
                    <Route path="/event/:id" element={<EventDetailPage events={events} user={user} />} />
            </Routes>
            <Footer />
        </div>
    </Router>
